				...
				<div class="container-fluid">
					...
					<div class="row"
						...
						<div class="col-sm-1 p-1">
							...
							<%=h.getGia()%></div>
						<div class="col-sm-2 p-1">
							Tổng tiền:<%=h.getThanhtien()%></div>
						<div class="col-sm-2 p-1">
							<form action="suacontroller?ms=<%=h.getMaskincare()%>"
								method="post">
								<input type="number" min="0" name="txtsl" style="width: 40px">
								<input type="submit" name="bts" value="Sua">
							</form>
						</div>
						<div class="col-sm-1 p-1">
							<button>
								<a style="text-decoration: none; color: #000"
									href="xoacontroller?ms=<%=h.getMaskincare()%>">Xoa</a>
							</button>
						</div>
					</div>
					<%
					...
					%>
					<div class="row">
						<b>Tong tien: <%=g.tong()%></b>
					</div>
					<form action="xacnhancontroller" method="post">
						<input type="submit" value="Xác nhận đặt mua" name="b1"class"btn-primary">
					</form>
					<%
					}
					%>
